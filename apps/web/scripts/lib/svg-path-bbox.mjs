/** Keep in sync with apps/web/src/lib/fleet/svg-path-bbox.ts */

function emptyBBox() {
  return { minX: Infinity, minY: Infinity, maxX: -Infinity, maxY: -Infinity };
}

function extendBBox(bbox, x, y) {
