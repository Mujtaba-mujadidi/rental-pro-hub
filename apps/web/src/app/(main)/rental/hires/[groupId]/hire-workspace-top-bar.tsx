  ...
  return (
    <div className="-mx-3 -mt-3 mb-5 px-3 pt-3">
      <div className="mb-3 flex flex-wrap items-center gap-2 text-sm">
        ...
        <div className="relative min-w-0 flex-1 sm:max-w-md" ref={rootRef}>
          <button
            type="button"
            className="inline-flex max-w-full items-center gap-1 font-mono font-semibold text-rph-fg hover:text-rph-link"
            aria-expanded={open}
            onClick={() => setOpen((v) => !v)}
          >
