export default function EsignEnvelopeLoading() {
  return (
    <div className="-m-4 flex min-h-[28rem] flex-col items-center justify-center gap-4 md:-m-6">
      ...
      <div className="text-center">
        <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">Loading contract</p>
        <p className="mt-1 text-xs text-slate-500">Opening the e-signature workspace…</p>
      </div>
    </div>
  );
}
