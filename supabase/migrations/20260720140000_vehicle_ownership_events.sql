-- Vehicle purchase / sale events for capital P&L (one purchase + one sale per vehicle in v1).
...
comment on table public.vehicle_ownership_events is
  'Vehicle capital events: company purchase and disposal (sale). One of each per vehicle in v1.';
