-- Restore driver_profiles creation for driver signups, and keep rental invite handling.
-- Previous handle_new_user (subcompany invite scope) dropped the driver_profiles branch,
-- so driver signups got profiles.role=driver with no driver_profiles row.
