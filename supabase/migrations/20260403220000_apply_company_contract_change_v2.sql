-- Align apply_company_contract_change with expanded contract version columns and workflow.
...
alter table public.companies
  add column if not exists superseded_by_company_id uuid references public.companies (id) on delete set null;

comment on column public.companies.superseded_by_company_id is
  'When set, this parent company was replaced by a new legal entity; memberships may have moved.';
